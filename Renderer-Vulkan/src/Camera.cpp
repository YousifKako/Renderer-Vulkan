...
void
Camera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
{
...
void
Camera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
{
    this->setViewDirection(position, target - position, up);
}

void
Camera::setViewYXZ(glm::vec3 position, glm::vec3 rotation)
{
